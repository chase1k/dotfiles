# Generated by Powerlevel10k configuration wizard on 2025-07-17 at 23:49 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=88
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%130F'   # burnt brown foreground
      local   modified='%124F'  # maroon foreground
      local  untracked='%137F'  # tan-brown foreground
      local conflicted='%196F'  # bright red foreground
    else
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=88
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=130
